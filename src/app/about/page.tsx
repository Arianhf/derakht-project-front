                ...
                <div className={styles.storyCard}>
                    ...
                    <div className={styles.storyContent}>
                        <div className={styles.storyText}>
                            ...
                            <p className={styles.storyParagraph}>
                                ما باور داریم که هر کودک داستان‌های منحصر به فردی در ذهن دارد که منتظر شکوفایی هستند. در سال ۱۴۰۱، گروهی از متخصصان آموزش کودک، برنامه‌نویسان و طراحان هنری گرد هم آمدند تا پلتفرم درخت را ایجاد کنند.
                            </p>
                            <p className={styles.storyParagraph}>
