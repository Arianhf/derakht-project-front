    ...
    parts: [
      {
        id: 'part-1',
        position: 1,
        canvas_text_data: { text: 'روزی روزگاری در جنگلی دور افتاده، یک خرگوش کوچک زندگی می‌کرد. او دوست داشت بازی کند و با دوستانش سرگرم شود.' },
        story_part_template: 'template-1',
        canvas_illustration_data: null,
        created_at: new Date().toISOString(),
      },
      {
        id: 'part-2',
        position: 2,
        canvas_text_data: { text: 'یک روز خرگوش کوچک تصمیم گرفت به ماجراجویی برود. او کوله‌پشتی خود را برداشت و راهی جنگل شد.' },
      ...
      },
      {
        id: 'part-3',
        position: 3,
        canvas_text_data: { text: 'در مسیر، خرگوش با یک پرنده زیبا آشنا شد. پرنده به او کمک کرد تا راه خانه را پیدا کند.' },
      ...
      },
      {
        id: 'part-4',
        position: 4,
        canvas_text_data: { text: 'سرانجام خرگوش به خانه رسید. او از ماجراجویی‌اش خیلی خوشحال بود و برای دوستانش قصه تعریف کرد.' },
